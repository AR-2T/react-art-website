...
function About() {
  return (
    ...
    {/* <div className="space-y-100 aboutPage h-screen">
      <div className ="section red text-7xl font-bold strokeAboutText">
        ABOUT US

        <div class="custom-shape-divider-bottom-1665272885">
